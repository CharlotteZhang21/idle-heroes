...
//     [], //so that first thing is button
//     [ //new interaction
//         {a: "attack", from: 3, delay:700, damage: 9}, //damange is in % of total health
...
//         {a: "attackAndFly", from: 0, to: 6, delay:1000, damage: 50 , effect:"shake"},
//         {a: "attackAndFly", from: 5, to: 6, delay:1000, damage: 50, effect:"shake"},
//         {a: "attackAndFly", from: 2, to: 1, delay:1000, damage: 50},
//         {a: "attackAndFly", from: 1, to: 0, delay:1000, damage: 20},
//         {a: "attack", from: 3, to: 0, delay: 1000, damage: 7},
//         {a: "attackAndFly", from: 0, to: 3, delay:1000, damage: 55},
//         {a: "attackAndFly", from: 5, to: 4, delay:1000, damage: 55},
//         {a: "attack", from: 2, delay:1000, damage: 50, effect:"shake-big"},
//     ]
// ];
...
PiecSettings.battleScript = [
    ...
    [
        {a: "attackAndFly", from: 0, to: 3, delay:500, damage: 55},
        {a: "attackAndFly", from: 5, to: 4, delay:1000, damage: 55},
        {a: "attack", from: 2, delay:1000, damage: 50, effect:"shake-big"},
    ]
];
